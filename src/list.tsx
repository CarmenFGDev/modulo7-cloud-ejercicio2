    ...
    return (
      <>
        ...
        <div className="search-container">
          ...
          <Button variant="text" onClick={ handleOnClick } className="btn-search">Search</Button>
        </div>
      
        <List>
          { (members.length === 0 )
            ? <Alert variant="outlined" severity="warning"> Not Found </Alert> 
        ...
        <Pagination count={Math.trunc(totalElements/PAGE_SIZE)} onChange={handleChange} />
      </>
    );
};